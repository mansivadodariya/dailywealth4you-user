...
const brokers = [
    { name: 'Skyriss', icon: '/assets/icons/Exness.svg' },
    { name: 'Vantage', icon: '/assets/icons/Exness.svg' },
    { name: 'Exness', icon: '/assets/icons/Exness.svg' },
    { name: 'OctaFx', icon: '/assets/icons/Exness.svg' },
];
        ...
        <div className={styles.mt5AccountWrapper}>
            <div className={styles.modal}>
                <div className={styles.modalHeader}>
                    ...
                    <p>
                        Create a new MT5 account or use existing
                    </p>
                </div>
                <div className={styles.modalbody}>
                    <div className={styles.realtive} ref={dropdownRef}>
                        <div className={styles.inputBox} onClick={toggleDropdown}>
                            <input
                                ...
                                placeholder='Select a Forex Broker'
                            />
                            <div className={`${styles.rightIcon} ${isOpen ? styles.rotated : ''}`}>
                    ...
                    <AuthButton outline text="Use Existing MT5 Account" icon={RightWhiteIcon} />
                </div>
            </div>
        </div>
    )
